...
if(SAPI_LIBUNWIND_PROVIDER STREQUAL "fetch")
  ...
  set(SAPI_LIBUNWIND_POPULATE_DIR
    "${SAPI_SUPERBUILD_BASE_DIR}/libunwind-populate" CACHE STRING "")
  set(SAPI_LIBUNWIND_SOURCE_DIR
    "${SAPI_SUPERBUILD_BASE_DIR}/libunwind-src" CACHE STRING "")
  set(SAPI_LIBUNWIND_BINARY_DIR
    "${SAPI_SUPERBUILD_BASE_DIR}/libunwind-build" CACHE STRING "")
  file(WRITE "${SAPI_LIBUNWIND_POPULATE_DIR}/CMakeLists.txt" "\
...
")
  execute_process(COMMAND ${CMAKE_COMMAND} -G "${CMAKE_GENERATOR}" .
                  ...
                  WORKING_DIRECTORY "${SAPI_LIBUNWIND_POPULATE_DIR}")
  if(error)
...
if(SAPI_LIBUNWIND_PROVIDER STREQUAL "package")
  # TODO(cblichmann): How to do this with system-installed packages?
else()
  if(SAPI_LIBUNWIND_PROVIDER STREQUAL "fetch")
  ...
  set(SAPI_LIBUNWIND_SOURCE_DIR "${libunwind_SOURCE_DIR}")
