...
if(SAPI_ZLIB_PROVIDER STREQUAL "fetch")
  ...
  set(SAPI_ZLIB_POPULATE_DIR
    "${SAPI_SUPERBUILD_BASE_DIR}/zlib-populate" CACHE STRING "")
  set(SAPI_ZLIB_SOURCE_DIR
    "${SAPI_SUPERBUILD_BASE_DIR}/zlib-src" CACHE STRING "")
  set(SAPI_ZLIB_BINARY_DIR
    "${SAPI_SUPERBUILD_BASE_DIR}/zlib-build" CACHE STRING "")
  file(WRITE "${SAPI_ZLIB_POPULATE_DIR}/CMakeLists.txt" "\
...
")
  execute_process(COMMAND ${CMAKE_COMMAND} -G "${CMAKE_GENERATOR}" .
                  ...
                  WORKING_DIRECTORY "${SAPI_ZLIB_POPULATE_DIR}")
  if(error)
...
if(SAPI_ZLIB_PROVIDER STREQUAL "package")
  ...
  if(SAPI_ZLIB_PROVIDER STREQUAL "fetch")
    ...
    if(NOT zlib_POPULATED)
      ...
      set(SAPI_ZLIB_SOURCE_DIR "${zlib_SOURCE_DIR}")
    endif()
  endif()
