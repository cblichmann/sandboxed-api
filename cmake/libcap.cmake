...
if(SAPI_LIBCAP_PROVIDER STREQUAL "fetch")
  FetchContent_Declare(libcap
    URL      "${SAPI_LIBCAP_URL}"
    URL_HASH "${SAPI_LIBCAP_URL_HASH}"
  )
else()
  set(SAPI_LIBCAP_POPULATE_DIR
    "${SAPI_SUPERBUILD_BASE_DIR}/libcap-populate" CACHE STRING "")
  set(SAPI_LIBCAP_SOURCE_DIR
    "${SAPI_SUPERBUILD_BASE_DIR}/libcap-src" CACHE STRING "")
  set(SAPI_LIBCAP_BINARY_DIR
    "${SAPI_SUPERBUILD_BASE_DIR}/libcap-build" CACHE STRING "")
  file(WRITE "${SAPI_LIBCAP_POPULATE_DIR}/CMakeLists.txt" "\
...
")
  execute_process(COMMAND ${CMAKE_COMMAND} -G "${CMAKE_GENERATOR}" .
                  ...
                  WORKING_DIRECTORY "${SAPI_LIBCAP_POPULATE_DIR}")
  if(error)
...
if(SAPI_LIBCAP_PROVIDER STREQUAL "package")
  ...
  if(SAPI_LIBCAP_PROVIDER STREQUAL "fetch")
    ...
    if(NOT libcap_POPULATED)
      ...
      set(SAPI_LIBCAP_SOURCE_DIR "${libcap_SOURCE_DIR}")
    endif()
  endif()
